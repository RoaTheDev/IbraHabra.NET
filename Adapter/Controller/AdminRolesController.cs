...
// using IbraHabra.NET.Application.UseCases.Admin.Commands.CreateRole;
// using IbraHabra.NET.Application.UseCases.Admin.Commands.RemoveRole;
...
//             ? CreatedAtAction(nameof(GetRole), new { roleId = result.Value!.RoleId }, result) 
